        ...
        <Box px={2} sx={{
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                    <SvgIcon component={HelloIcon} inheritViewBox sx={{ color: 'primary.main' }} />
                    <Typography variant="span" sx={{ fontSize: '1.1rem', fontWeight: 'bold', color: 'primary.main' }}>Hello</Typography>
                </Box>
